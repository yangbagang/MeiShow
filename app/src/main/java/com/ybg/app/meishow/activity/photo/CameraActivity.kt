...
class CameraActivity : BaseActivity() {
    ...
    private val photoWidth = CameraUtil.cameraPhotoWidth
    ...
    override fun init() {
        ...
        params.height = CameraUtil.cameraPhotoAreaHeight
        params = rl_take_parent!!.layoutParams
        params.height = ScreenUtils.getScreenHeight(mContext!!) - ScreenUtils.getScreenWidth(mContext!!) - ScreenUtils.getStatusHeight(mContext!!) - CameraUtil.cameraPhotoAreaHeight
    }
    ...
    fun saveToSDCard(data: ByteArray): String? {
        ...
        val imagePath = BitmapUtils.saveToFile(AppConstant.IMAGE_SAVE_PATH, true, croppedImage)
