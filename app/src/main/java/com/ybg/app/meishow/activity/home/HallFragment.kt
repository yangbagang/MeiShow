...
class HallFragment : BaseFragment() {
    ...
    override fun init() {
        ...
        mFragment.add(FollowFragment.instance)
        ...
        slidingTabs.addTab(slidingTabs.newTab().setText("新鲜"))
        slidingTabs.addTab(slidingTabs.newTab().setText("关注"))
